    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='productos', to='products.categoryproduct', verbose_name='Categoría de Producto')),
            ],
            options={
